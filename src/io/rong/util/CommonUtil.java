...
public class CommonUtil {
    ...
    public static String checkFiled(Object model,String path,String method){
        try {
            ...
            Map<String,String[]> checkInfo = getCheckFileds(path,method);
    ...
    */
    ...
    public static String checkParam(String checkFiled,Object value,String path,String method){
        try {
            ...
            String checkObject = "";
            //获取需要校验的key
            Map<String,String[]> checkInfo = getCheckFileds(apiPath,method);
            for (Map.Entry<String,String[]> entry : checkInfo.entrySet()) {
                //fileds = entry.getValue();
    ...
    public static Map<String,String[]> getCheckFileds(String path,String method){
        JSONObject api = null;
        try {
            api = JsonUtil.getJsonObject2(path);
