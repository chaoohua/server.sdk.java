...
import io.rong.models.group.GroupResponseResult;
...
public class Group {
	 ...
	 **/
	public ResponseResult create(io.rong.models.group.Group params) throws Exception {
		//参数校验
		GroupResponseResult groupResponseResult = CommonUtil.checkParamter(params,"GroupResponseResult");

		if(null != groupResponseResult){
			return  groupResponseResult;
		}
		StringBuilder sb = new StringBuilder();

	    for (int i = 0 ; i< params.userId.length; i++) {
			String child  = params.userId[i];
			sb.append("&userId=").append(URLEncoder.encode(child, UTF8));
		}

	    sb.append("&groupId=").append(URLEncoder.encode(params.groupId.toString(), UTF8));
	    sb.append("&groupName=").append(URLEncoder.encode(params.groupName.toString(), UTF8));
	    ...
	    return (GroupResponseResult) GsonUtil.fromJson(HttpUtil.returnResult(conn), CodeSuccessResult.class);
	}
	 ...
	 * @return CodeSuccessResult
	 **/
	public ResponseResult sync(String userId, GroupInfo[] groupInfo) throws Exception {
		if (userId == null) {
	    ...
	    return (GroupResponseResult) GsonUtil.fromJson(HttpUtil.returnResult(conn), GroupResponseResult.class);
	}
	 ...
	 * @return CodeSuccessResult
	 **/
	public ResponseResult refresh(String groupId, String groupName) throws Exception {
		if (groupId == null) {
	 ...
	 *
	 * @param params 用户加入指定群组参数
	 *
	 * @return CodeSuccessResult
	 **/
	public ResponseResult join(io.rong.models.group.Group params) throws Exception {
		//参数校验
		GroupResponseResult groupResponseResult = CommonUtil.checkParamter(params,"GroupResponseResult");
	 ...
	 * @return CodeSuccessResult
	 **/
	public ResponseResult quit(String[] userId, String groupId) throws Exception {
		if (userId == null) {
			throw new IllegalArgumentException("Paramer 'userId' is required");
		}
	 ...
	 * @return CodeSuccessResult
	 **/
	public GroupResponseResult addGagUser(String[] userId, String groupId, String minute) throws Exception {
		if (userId == null) {
			throw new IllegalArgumentException("Paramer 'userId' is required");
		}
	 ...
	 * @return CodeSuccessResult
	 **/
	public GroupResponseResult rollBackGagUser(String[] userId, String groupId) throws Exception {
		if (userId == null) {
			throw new IllegalArgumentException("Paramer 'userId' is required");
		}
	 ...
	 * @return CodeSuccessResult
	 **/
	public GroupResponseResult dismiss(String userId, String groupId) throws Exception {
		if (userId == null) {
			throw new IllegalArgumentException("Paramer 'userId' is required");
		}
